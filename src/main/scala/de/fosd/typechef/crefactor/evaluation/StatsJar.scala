...
object Stats extends Enumeration {
    ...
    val Parsing, TypeCheck, InlinedFunction, RandomRefactorDeterminationTime, PrettyPrint, RenamedId, Amount, RefactorTime, AffectedFeatures, TestingTime, Variants, Statements, ExternalUses, ExternalDecls, Parameters, Liveness = Value
